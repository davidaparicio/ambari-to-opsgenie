# ---------------------------------------------------------------------------- #
#                                                                              #
# Ambari To Opsgenie, easy tool to forward Ambari alerts to OpsGenie (on-call) #
#                                                                              #
# ---------------------------------------------------------------------------- #
#                                                                              #
#                  MIT, Copyright © 2023 David Aparicio                        #
#                                                                              #
# ---------------------------------------------------------------------------- #
...
PKG_LDFLAGS := github.com/davidaparicio/ambari-to-opsgenie/internal
